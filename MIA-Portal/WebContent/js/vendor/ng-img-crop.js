...
crop.factory('cropAreaRectangle', ['cropArea', function (CropArea) {
    ...
    CropAreaRectangle.prototype._calcRectangleCorners = function () {
        ...
        widthRectangle=size.w;
        //alert(widthRectangle);
        heightRectangle=size.h;
...
crop.factory('cropAreaSquare', ['cropArea', function(CropArea) {
    ...
    CropAreaSquare.prototype._calcSquareDimensions = function() {
        ...
        return {
            ...
            top: size.y,
            right: se.x,
            bottom: se.y/**@bharat- se.y and se.x used to select center moving of cropper selection **/
        };
    };
...
crop.factory('cropArea', ['cropCanvas', function(CropCanvas) {
    var CropArea = function(ctx, events) {
        ...
        ****
        *@bharat
        **To set cropper 0 selection Use
        **** this._minSize = {
            x: 0,
            y: 0,
            w: 0,
...
crop.service('cropHost', ['$document', '$q', 'cropAreaCircle', 'cropAreaSquare', 'cropAreaRectangle', 'cropEXIF', function($document, $q, CropAreaCircle, CropAreaSquare, CropAreaRectangle, cropEXIF) {
    /* STATIC FUNCTIONS */
    ...
    var getElementOffset = function(elem) {
     ...
     return function(elCanvas, opts, events) {
        ...
        var ctx = null,
             ...
             * 
             * @bharat 
             * Resulting image should be in size as cropped
             * if u want resulting image in fix size plz uncomment resImgSize and provide heigh and width
             * if u not using aspect ration and array image size in imgCrop directive html
             */
            /*resImgSize = {
                w: 200,
                h: 200
            ...
            // Result Image type
            //@bharat-specify result image type here
        ...
        this.getResultImageSize = function() {
        	...
        	/**
        	 * @bharat
        	 * not want resulting image with specified size
        	 * if want uncomment resImgSize
        	 */
        	...
        	if ("selection") {
            	...
            	/*@bharat-not want resulting image with specified size*/
        	...
        	/**
        	 * @bharat
        	 * Not want resulting image with specified width and height
        	 * **/
            /*return resImgSize;*/
        ...
        this.setResultImageSize = function(size) {
            ...
            if (angular.isString(size)) {
            	...
            	/*@bharat-not want resulting image with specified height and width*/
               /* resImgSize = size;*/
        ...
        link: function (scope, element) {
            ...
            var updateResultImage = function (scope, force, callback) {
                if (scope.image !== '' && (!scope.liveView.block || force)) {
                    ...
                    $rootScope.saveCroppedImage = resultImage;
                    //alert($rootScope.saveCroppedImage)
                    /*****
                    *@bharat
                    *Here is newly Cropped Image result
                    ******/
