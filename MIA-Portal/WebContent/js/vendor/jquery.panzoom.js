...
(function(global, factory) {
	...
	Panzoom.defaults = {
		 ...
		 * @Author : bharat
		 * @Version : 1.0
		 * SET MAX SCALE AND MIN SCALE
		 * This is point where we can set maximum zoom in and maximum zoom out 
		 */
	...
	Panzoom.prototype = {
		...
		_bind: function() {
			 ...
			 * @Version : 1.0
			 * DRAG START STOP
			 * This if condition uncomment will cause to drag map 
			 */
		...
		/*********************
		 * @Author:bharat
		 * This is required for  calculating two points
		 */
		/**
